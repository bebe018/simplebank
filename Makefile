...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/bebe018/simplebank/db/sqlc Store
...
.PHONY: createdb dropdb postgres migrateup migratedown sqlc test server mock migrateup1 migratedown1 db_docs db_schema